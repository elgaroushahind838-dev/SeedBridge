...
<g clip-path="url(#clip0_2154_2114)">
...
const FacebookIcon = () => (
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<g clip-path="url(#clip0_2154_2122)">
...
export const CreateSMA = () => {
  ...
  const canSubmit =
    businessName.trim().length > 0 && emailValid && passValid && confirmValid && agree;
 ...
 const onSubmit = (e) => {
      ...
      <main className="hero">
        <div className="hero-wrap">
          <section className="hero-card">
            ...
            <h1 className="sma-h1">Create your SMA account</h1>
  ...
  Confirm Password <span className="sma-star">*</span>
                ...
                <input
                  className={`sma-input ${
                    confirm.length > 0 && !confirmValid ? "is-error" : ""
                  }`}
                  type="password"
                  placeholder="**********"
                  value={confirm}
